 ...
 * @LastEditors: hqk
 * @LastEditTime: 2022-12-23 19:02:26
 * @Description:
-->
...
<template>
  <div class="not-found flex justify-center items-center">
    <div class="not-found__body flex flex-col items-center px-20 py-12 border-gray-50 border-2 rounded-3xl shadow-xl">
